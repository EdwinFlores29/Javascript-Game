 ...
 * Ítem #1
 * Cambiar el color del título y alternar indefinidamente
 */
 ...
 * Los requerimientos específicos:
 * Ítem #2
 * Dulces aleatoriamente en el tablero
 */
 ...
 * Los requerimientos específicos:
 * Ítem #4
 * Temporizador a dos minutos/ inicie con el juego/ cambie la página del tablero
 * Ítem #5
 * Aumentar el contador y que se muestre en pantalla
 Ítem #6
 * Cambiar el contenido de botón Iniciar a Reiniciar una vez termine el juego
 Ítem #7, 8
 * Interacción Drag& en Drop, anotar los puntos.
 */
...
function endGame() {
	...
	$('h1.main-titulo')
		$('h1.main-secondary').addClass()
			.text('Juego Terminado').css('color', 'white');
